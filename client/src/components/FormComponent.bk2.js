...
class FormComponent extends Component {
    ...
    <div class="col-md-12 container">
      <h4 class="text-white text-center">Place an order</h4>
      <br />
            ...
            <div class="row align-items-center">
              <div class="col-md-12 container leftSide">
                <div class="scrollable-content">
                    <h5 class="text-center">Fill form below</h5>
                <form
                ...
                >
                    <div>
                        <div class="form-group">
                          <label for="emailInput">Select Service</label>
                          &nbsp; &nbsp;
                          <select
                            name={'service'}
                            value={service}
                        ...
                        <div>
                        <div class="form-group">
                            <label for="customerNameInput">Customer Address: {customer_address}</label>
                            <input
                                class="form-control"
